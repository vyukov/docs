...
.. table:: 
    ...
    +--------------------------------------+---------------------+--------------------+
    | Modeling dep (sets & props)          | Рафаель Бланко      | Ирина Момотюк      |
    +--------------------------------------+---------------------+--------------------+
    | Rigging dep                          | Максим Шушпанов     | Ирина Момотюк      |
    +--------------------------------------+---------------------+--------------------+
    | Layout dep                           | Виктор Король       | Мария Клаунинг     |
    +--------------------------------------+---------------------+--------------------+
    | Animation dep                        | Антон Савин         | Мария Клаунинг     |
    +--------------------------------------+---------------------+--------------------+
    | Compositing dep                      | Павел Подорван      | Александра Луценко |
    +--------------------------------------+---------------------+--------------------+
    | Lighting dep                         | Станислав Кичик     | Александра Луценко |
    +--------------------------------------+---------------------+--------------------+
    | VFX dep                              | Андрей Алтухов      | Мария Смирнова     |
    +--------------------------------------+---------------------+--------------------+
    | CFX dep (character fx)               | Дмитрий Косовский   | Мария Смирнова     |
    +--------------------------------------+---------------------+--------------------+
    | **dep**                              | **Pipeline TD**     | **координатор**    |
    +--------------------------------------+---------------------+--------------------+
    | Pipeline dep \ Technical support     | Дмитрий Стабров     | Даниил Вьюков      |
    +--------------------------------------+---------------------+--------------------+
    | **dep**                              | **R&D TD**          | **координатор      |
    +--------------------------------------+---------------------+--------------------+
    | R&D dep                              | Андрей Милицкий     | Даниил Вьюков      |
    +--------------------------------------+---------------------+--------------------+
    | **dep**                              | **IT Director**     | **координатор**    |
    +--------------------------------------+---------------------+--------------------+
    | IT dep                               | Сергей Невмержицкий | Даниил Вьюков      |
    +--------------------------------------+---------------------+--------------------+
